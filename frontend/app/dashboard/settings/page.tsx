    ...
    <div className="relative z-10">
      ...
      <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
            <button 
                ...
                className={cn(
                    "px-10 py-5 rounded-xl text-white font-black text-xs uppercase tracking-[0.2em] shadow-pop-lg transition-all flex items-center gap-4 active:scale-95 disabled:opacity-50",
      ...
      <AnimatePresence>
        {successMessage && (
          <motion.div
            ...
            exit={{ y: -20, opacity: 0 }}
            className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] bg-green-500 text-white px-8 py-4 rounded-2xl shadow-pop-lg flex items-center gap-4 font-black text-xs uppercase tracking-widest border border-white/20"
          >
        ...
        {errorMessage && (
          <motion.div
            ...
            animate={{ y: 0, opacity: 1 }}
            exit={{ y: -20, opacity: 0 }}
            className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] bg-red-500 text-white px-8 py-4 rounded-2xl shadow-pop-lg flex items-center gap-4 font-black text-xs uppercase tracking-widest border border-white/20"
          >
            <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-3">
          <div className={cn("p-2 rounded-2xl border transition-colors", theme.colors.surface, theme.colors.border)}>
            {navItems.map((item) => (
                <button
                key={item.id}
                onClick={() => setActiveTab(item.id as SettingsTab)}
                className={cn(
                    "w-full flex items-center gap-5 p-5 rounded-2xl text-left transition-all duration-300 relative group",
                    activeTab === item.id 
                    ? "bg-muted"
                ...
                <div className={cn(
                    ...
                    activeTab === item.id ? theme.colors.primary : cn(theme.colors.bg, "border shadow-pop-sm", theme.colors.border)
                )}>
        ...
        <div className="lg:col-span-8">
          <AnimatePresence mode="wait">
            ...
            >
              {activeTab === 'profile' && (
                <>
                  <section className={cn("p-10 rounded-2xl border shadow-pop-lg space-y-10 transition-colors", theme.colors.surface, theme.colors.border)}>
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                            <div className={cn("w-36 h-32 rounded-2xl flex items-center justify-center border-4 shadow-pop-lg transition-all group-hover:rotate-3 group-hover:scale-105 overflow-hidden", theme.colors.bg, theme.colors.border)}>
                                {isUploading ? (
                                    <Loader2 className={cn("w-10 h-10 animate-spin", theme.colors.text, "opacity-40")} />
                                ) : formData.avatarUrl ? (
                                    <img src={formData.avatarUrl} className="w-full h-full object-cover rounded-2xl" alt="Avatar" />
                                ) : (
                                    <User className={cn("w-14 h-14 opacity-20", theme.colors.text)} />
                                )}
                            </div>
                            <div className={cn("absolute -bottom-3 -right-3 w-12 h-12 rounded-xl flex items-center justify-center shadow-pop-lg border-4 border-primary/30", theme.colors.primaryMuted, theme.colors.accent)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                      <div className="space-y-3">
                        ...
                        <input 
                          ...
                          className={cn("w-full px-6 py-5 rounded-xl border font-bold text-sm focus:ring-[12px] focus:ring-primary/5 outline-none transition-all shadow-pop-sm", theme.colors.bg, theme.colors.border, theme.colors.text)}
                        />
                      </div>
                      <div className="space-y-3">
                        <label className={cn("text-[10px] font-black uppercase tracking-[0.2em] ml-2 flex items-center gap-2", theme.colors.textMuted)}>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className={cn("w-full pl-14 pr-6 py-5 rounded-xl border font-bold text-sm focus:ring-[12px] focus:ring-primary/5 outline-none transition-all shadow-pop-sm", theme.colors.bg, theme.colors.border, theme.colors.text)}
                            />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea 
                            ...
                            maxLength={500}
                            className={cn("w-full px-8 py-7 rounded-2xl border font-medium text-sm focus:ring-[12px] focus:ring-primary/5 outline-none transition-all h-40 resize-none shadow-pop-sm", theme.colors.bg, theme.colors.border, theme.colors.text)}
                        />
                    </div>
                  </section>
                  
                  {/* Account Metadata */}
                  <section className={cn("p-10 rounded-2xl border shadow-pop-lg space-y-8 transition-colors", theme.colors.surface, theme.colors.border)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className={cn("p-6 rounded-2xl border flex items-center gap-5 transition-colors", theme.colors.bg, theme.colors.border)}>
                            <div className="w-12 h-12 rounded-xl bg-white shadow-pop-sm flex items-center justify-center border border-slate-100">
                        ...
                        <div className={cn("p-6 rounded-2xl border flex items-center gap-5 transition-colors", theme.colors.bg, theme.colors.border)}>
                            <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center", theme.colors.surface)}>
              ...
              {activeTab === 'appearance' && (
                <section className={cn("p-12 rounded-2xl border shadow-pop-lg space-y-12 transition-colors", theme.colors.surface, theme.colors.border)}>
                  <div className="flex items-center gap-6">
                    <div className={cn("w-16 h-16 rounded-2xl flex items-center justify-center shadow-pop-lg", theme.colors.primaryMuted)}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    {[
                      ...
                      { type: 'dark', label: t('settings.appearance.modes.midnight.label'), desc: t('settings.appearance.modes.midnight.desc'), icon: Moon, color: 'bg-slate-700', shadow: 'shadow-black/20' }
                    ].map((mode) => (
                      <button
                        key={mode.type}
                        onClick={() => setTheme(mode.type as any)}
                          className={cn(
                            "group p-10 rounded-2xl border-4 transition-all text-left space-y-6 relative overflow-hidden",
                          themeType === mode.type 
                            ? (mode.type === 'light' ? "border-orange-500 bg-orange-500/[0.05]" : "border-slate-500 bg-slate-500/[0.05]")
                            : cn(theme.colors.border, "hover:border-border")
                        )}
                      >
                        <div className={cn("w-16 h-16 rounded-xl flex items-center justify-center shadow-pop-lg transition-transform group-hover:scale-110", mode.color, mode.shadow)}>
                          <mode.icon className="w-8 h-8 text-white" />
                        </div>
                        <div>
                          <p className={cn("font-black text-base uppercase tracking-[0.2em]", themeType === mode.type                             ? (mode.type === 'light' ? "text-orange-600" : "text-slate-400") : theme.colors.text)}>{mode.label}</p>
                  ...
                  <div className={cn("p-10 rounded-2xl border border-dashed flex flex-col items-center text-center gap-6 transition-all", theme.colors.border, "hover:bg-black/5 dark:hover:bg-white/5")}>
                      <div className={cn("w-16 h-16 rounded-xl flex items-center justify-center", theme.colors.surface, theme.colors.border, "border")}>
                      ...
                      <button 
                        ...
                        className={cn("px-10 py-3 rounded-xl border-2 font-black text-[10px] uppercase tracking-widest transition-all", theme.colors.border, theme.colors.text, "hover:opacity-60")}
                      >
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      { id: 'marketing', label: t('settings.notifications.marketing.label'), desc: t('settings.notifications.marketing.desc'), icon: Zap, state: formData.notificationPreferences.marketing, key: 'marketing' },
                        ...
                        <div key={toggle.id} className={cn("flex items-center justify-between p-10 rounded-2xl border transition-all hover:scale-[1.01] hover:shadow-pop-lg", theme.colors.bg, theme.colors.border)}>
                            <div className="flex items-center gap-8">
                                <div className={cn("w-16 h-16 rounded-xl flex items-center justify-center border shadow-pop-sm", theme.colors.surface, theme.colors.border)}>
                            ...
                            <button 
                                ...
                                className={cn(
                                    ...
                                    toggle.state ? theme.colors.primary : "bg-muted"
                                )}
                            >
                                <motion.div 
                                    animate={{ x: toggle.state ? 28 : 0 }}
                                    className="w-6 h-6 rounded-full bg-white shadow-pop-lg"
                                />
                            </button>
                        </div>
                    ))}
                ...
                <div className="space-y-10">
                    <section className={cn("p-12 rounded-2xl border shadow-pop-lg space-y-12 transition-colors", theme.colors.surface, theme.colors.border)}>
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <input 
                                        ...
                                        placeholder="••••••••" 
                                        className={cn("w-full px-8 py-6 rounded-xl border font-bold text-sm outline-none transition-all focus:ring-[12px] focus:ring-primary/5", theme.colors.bg, theme.colors.border, theme.colors.text)} 
                                    />
                                </div>
                                <div className="space-y-3">
                            ...
                            <div className={cn("p-8 rounded-2xl border bg-amber-500/5 border-amber-500/10 flex items-start gap-5")}>
                            ...
                            <button 
                                ...
                                className={cn("w-full py-6 rounded-xl border-4 font-black text-xs uppercase tracking-[0.3em] transition-all hover:bg-black/5 dark:hover:bg-white/5 active:scale-[0.98] flex items-center justify-center gap-3", theme.colors.border, theme.colors.text)}
                            >
                    ...
                    <section className={cn("p-12 rounded-2xl border border-red-500/20 bg-red-500/[0.03] space-y-10 relative overflow-hidden")}>
                        ...
                        <div className="p-10 rounded-2xl border-2 border-red-500/20 bg-red-500/5 space-y-8 relative z-10">
                             <div className="space-y-2">
                             ...
                             <button 
                                ...
                                className=                                "w-full py-5 rounded-xl bg-red-500 text-white font-black text-xs uppercase tracking-[0.3em] hover:bg-red-600 transition-all shadow-pop-lg shadow-red-500/40 active:scale-95 flex items-center justify-center gap-3"
                             >
              ...
              {activeTab === 'preferences' && (
                <section className={cn("p-12 rounded-2xl border shadow-pop-lg space-y-12 transition-colors", theme.colors.surface, theme.colors.border)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <select 
                                ...
                                className={cn("w-full px-8 py-6 rounded-xl border font-bold text-sm outline-none appearance-none cursor-pointer focus:ring-[12px] focus:ring-primary/5 transition-all shadow-pop-sm", theme.colors.bg, theme.colors.border, theme.colors.text)}
                            >
                    ...
                    <div className={cn("p-10 rounded-2xl border border-dashed flex items-center justify-between gap-10 transition-colors", theme.colors.border, "hover:bg-black/5 dark:hover:bg-white/5")}>
                        <div className="flex items-center gap-8">
                            <div className={cn("w-16 h-16 rounded-xl flex items-center justify-center border shadow-pop-sm", theme.colors.surface)}>
